...
| 10 | `lua/plugins/lsp/cmp.lua` | blink.cmp, LuaSnip, friendly-snippets | ✅ 완료 |
...
| 18 | `lua/plugins/ui/toggleterm.lua` | toggleterm | ✅ 완료 |
| 19 | `lua/plugins/ui/colorscheme.lua` | github-nvim-theme (dark_high_contrast) | ✅ 완료 |
| 20 | `lua/plugins/editor/markdown-table.lua` | vim-table-mode | ✅ 완료 |
| 21 | `lua/plugins/editor/render-markdown.lua` | render-markdown.nvim | ✅ 완료 |
| 22 | `lua/plugins/debug/dap.lua` | nvim-dap, nvim-dap-ui, nvim-dap-go | ✅ 완료 |
| 23 | `lua/plugins/ai/claudecode.lua` | claudecode.nvim | ✅ 완료 |
...
## Phase 5: Language Extras (LazyExtras 스타일)

| 순서 | 파일 | 언어 | 상태 |
|---|---|---|---|
| 1 | `lua/extras/lang/go.lua` | Go (gopls, gofumpt, goimports, treesitter) | ✅ 완료 |
| 2 | `lua/extras/lang/python.lua` | Python (pyright, black, isort, treesitter) | ✅ 완료 |
| 3 | `lua/extras/lang/ops.lua` | YAML/JSON/Bash/Dockerfile/SQL | ✅ 완료 |
