...
map({ "n", "v" }, "x", '"_x', opts("[삭제] 클립보드 오염 없이 한 글자 삭제"))
...
-- obsidian.nvim (Obsidian vault 통합)
map("n", "<leader>on", "<cmd>ObsidianNew<cr>", opts("[Obsidian] 새 노트 생성"))
map("n", "<leader>oo", "<cmd>ObsidianOpen<cr>", opts("[Obsidian] Obsidian 앱에서 열기"))
map("n", "<leader>os", "<cmd>ObsidianSearch<cr>", opts("[Obsidian] vault 전체 검색"))
map("n", "<leader>oq", "<cmd>ObsidianQuickSwitch<cr>", opts("[Obsidian] 노트 빠른 전환"))
map("n", "<leader>ot", "<cmd>ObsidianToday<cr>", opts("[Obsidian] 오늘 일간 노트"))
map("n", "<leader>oy", "<cmd>ObsidianYesterday<cr>", opts("[Obsidian] 어제 일간 노트"))
map("n", "<leader>om", "<cmd>ObsidianTomorrow<cr>", opts("[Obsidian] 내일 일간 노트"))
map("n", "<leader>ob", "<cmd>ObsidianBacklinks<cr>", opts("[Obsidian] 백링크 보기"))
map("n", "<leader>og", "<cmd>ObsidianTags<cr>", opts("[Obsidian] 태그 검색"))
map("n", "<leader>op", "<cmd>ObsidianPasteImg<cr>", opts("[Obsidian] 이미지 붙여넣기"))
map("n", "<leader>or", "<cmd>ObsidianRename<cr>", opts("[Obsidian] 노트 이름 변경"))
map("n", "<leader>ow", "<cmd>ObsidianTemplate<cr>", opts("[Obsidian] 템플릿 삽입"))
