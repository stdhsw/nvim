...
local dap_python = lazy_require("dap-python")
...
-- nvim-dap-python (Python 디버깅)
map("n", "<leader>dpt", function()
	dap_python().test_method()
end, opts("[DAP-Python] 디버깅 Python 테스트 메서드"))
map("n", "<leader>dpc", function()
	dap_python().test_class()
end, opts("[DAP-Python] 디버깅 Python 테스트 클래스"))
map("v", "<leader>dps", function()
	dap_python().debug_selection()
end, opts("[DAP-Python] 디버깅 Python 선택 영역"))
